...
For the code used to obtain the fits, see the [previous analysis](MASHvFLASHgtex2.html#code). For additional code used in this analysis, see [below](#code).
...
```{r ohf_not_mash}
ohf.v.mash <- compare_methods(fl_lfsr, m_lfsr)
