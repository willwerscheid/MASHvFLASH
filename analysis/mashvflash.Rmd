...
The FLASH fit took `r basic_res$fl_time`. The MASH fit took `r basic_res$m_time`.
...
The FLASH fit took `r flash_res$fl_time`. The MASH fit took `r flash_res$m_time`.
...
The FLASH fit took `r mash_res$fl_time`. The MASH fit took `r mash_res$m_time`.
